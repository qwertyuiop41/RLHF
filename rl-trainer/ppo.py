...
class PPO():
    def __init__(self,
        ...
        self.criticModel = CriticModel(model)

        self.actor_optimizer = torch.optim.Adam(self.policyModel.parameters(), lr=config.lr)
        self.critic_optimizer = torch.optim.Adam(self.criticModel.parameters(), lr=config.lr)
